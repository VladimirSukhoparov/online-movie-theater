            ...
            >
                            ...
                            <ul>
                                {translation.sections.map((el, index) => {
                                    return (
                                        <Link
                                            href={el.path}
                                            key={translation.sections.indexOf(
                                                el
                                            )}
                                            onMouseEnter={() =>
                                                dpropdownMenu(index)
                ...
                {focus > 1 && focus < 5 ? (
                    <div className={styles.header_dropdown_container}>
                        ...
                        <div
                            className={styles.header_dropdown_countriesandyears}
                        >
                        ...
                        <div className={styles.header_dropdown_sidecontent}>
                            <div
                                className={
                                    styles.header_sidecontent_recomandation
                                }
                            >
                                <div
                                    className={
                                        styles.header_recomandation_scroll
                                    }
                                >
                                    <div
                    ...
                    <div className={styles.header_dropdown_container}>
                        ...
                        <div className={styles.header_shows_container}>
                            <div className={styles.header_shows_contant}>
                                <div
                                    className={styles.header_programs_container}
                                >
                                    <div className={styles.header_programs}>
                                        <div
                                            className={
                                                styles.header_programs_title
                                            }
                                        >
                                            Федеральные каналы
                                        </div>
                                        <div
                                            className={
                                                styles.header_programs_overflow
                                            }
                                        >
                                    ...
                                    <div className={styles.header_programs}>
                                        ...
                                        >
                                            {translation.tv_links.sport_channels.map(
                                                (el) => {
                                                    return (
                                                        <div
                                                            className={
                                    ...
                                    <div
                                        className={
                                            styles.header_liveaction_container
                                        }
                                    >
                                        <div
                                            className={
                                                styles.header_liveaction_title
                                            }
                                        >
                                        ...
                                        <div
                                            className={
                                                styles.header_liveaction_contant
                                            }
                                        >
                                            <div
                                                className={
                                                    styles.header_liveaction
                                                }
                                            >
                                                fsdfs
                                            </div>
