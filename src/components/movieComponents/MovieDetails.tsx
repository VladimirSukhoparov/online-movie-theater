...
const MovieDetails = (props) => {
    ...
    const film = films;
    const items = [
        { id: 1, name: translation.creators, href: "person", count: 0 },
        { id: 2, name: translation.comments, href: "comments", count: 0 },
        {
            id: 3,
            name: translation.trailers,
            href: "trailers",
            count: film.videos.trailers.length,
        },
    ];
                    ...
                    <div className={styles.movie_content}>
                        ...
                        >
                            {items.map((el) => (
                                ...
                                >
                                    <Link
                                        href={`/movies/${props.id}/${el.href}`}
                                    >
                                        {el.name}
                                    </Link>
                                    {!!el.count && <sup>{el.count}</sup>}
                                </li>
                            ))}
                        </ul>
                        <hr />
