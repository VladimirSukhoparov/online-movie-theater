...
const Footer = () => {
  const { footer: translation } = useLocale();
    ...
    <>
      <div className={styles.footer_container}>
        ...
        <div className={styles.footer_first_container}>
          {translation.ul.map((item: string[], index: number) => {
          ...
          <div className={styles.footer_third_content}>
            <div className={styles.third_content_title}>
              {translation.third_title}
            </div>
            <span>{translation.third_span}</span>
            <Button
              classN="footer_third_button"
              type="button"
              children={translation.third_button}
            />
